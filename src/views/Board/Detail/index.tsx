import CommentItem from 'components/CommentItem/inde';
...
export default function BoardDetail() {
  ...
  const BoardDetailTop = () => {
    ...
    //  function : getBoard response 처리 함수 //
    ...
    return (
      <div id='board-detail-top'>
        ...
        <div className='board-detail-top-main'>
          ...
          {board.boardImageList.map((image, idx) => <img className='board-detail-main-image' src={image} key={idx} />)}
        </div>
      </div>
    );
  };
  ...
  const BoardDetailBottom = () => {
    ...
    // function: post commnet response 처리 함수 //
    ...
    const onShowCommnetClickHandler = () => {
    ...
    //  event handler: 댓글 변경 클릭 이벤트 처리 //
    const onCommnetChangekHandler = (event: ChangeEvent<HTMLTextAreaElement>) => {
      ...
      <div id='board-detail-bottom'>
        <div className='board-detail-bottom-button-box'>
          ...
          <div className='board-detail-bottom-button-group'>
            ...
            <div className='icon-button' onClick={onShowCommnetClickHandler}>
              {showComment ?
                <div className='icon up-light-icon'></div> :
                <div className='icon down-light-icon'></div>
              }
          ...
          <div className='board-detail-bottom-favorite-box'>
            <div className='board-detail-bottom-favorite-container'>
              ...
              <div className='board-detail-bottom-favorite-content'>
                {favoriteList.map((item, idx) => <FavoriteItem favoriteListItem={item} key={idx} />)}
              </div>
            </div>
          </div>
        }
          ...
          <div className='board-detail-bottom-comment-box'>
            <div className='board-detail-bottom-comment-container'>
              ...
              <div className='board-detail-bottom-comment-list-container'>
                {viewList.map((item, idx) => <CommentItem commentListItem={item} key={idx} />)}
              </div>
            </div>
            ...
            {loginUser !== null &&
              <div className='board-detail-bottom-comment-input-box'>
                <div className='board-detail-bottom-comment-input-container'>
                  <textarea ref={commentRef} className='board-detail-bottom-comment-textarea' placeholder='댓글을 작성해주세요.' value={comment} onChange={onCommnetChangekHandler}></textarea>
