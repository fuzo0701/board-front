...
export default function BoardWrite() {
  ...
  const { title , setTitle, content , setContent,
          boardImageFileList, setBoardImageFileList } = useBoardStore();
  //  state : 로그인 유저 상태  //
  ...
  // event handler: 이미지 업로드 버튼 이벤트 처리 //
  const onImageButtonClickHandler = () => {
    if(!imageInputRef.current) return;
    imageInputRef.current.click();
  }
  // event handler: 이미지 닫기 버튼 이벤트 처리 //
  ...
  return (
    <div id="board-update-wrapper">
      <div className="board-wrtie-container">
        <div className='board-update-box'>
            ...
            <div className='board-update-content-box'>
              ...
              <div className='icon-button'  onClick={onImageButtonClickHandler}>
            ...
            { imageUrls.map((imageUrl, index) => 
              ...
              <div className="board-update-image-box">
                <img className='board-update-image' src={imageUrl} key={index}/>
